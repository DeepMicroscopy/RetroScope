...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        font=\small,
        box/.style={draw, rounded corners, align=center, text width=0.28\linewidth, minimum height=1.1cm, fill=gray!8},
        ...
        \node[box, right=of rq1] (rq2) {RQ2\\Low-cost scale and motion};
