...
This paper presents RetroScope, an open platform for motorizing and digitizing vintage microscopes. It provides a unified, MIT-licensed framework that can be attached to arbitrary non-motorized optical microscopes. The main contributions are:
\begin{enumerate}
