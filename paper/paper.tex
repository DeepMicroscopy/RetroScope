...
\begin{document}
%
\title{RetroScope: An Open Framework for Motorizing and Digitizing Vintage Microscopes}
...
\includegraphics[width=0.5\textwidth]{figures/platform_prototype_new.png} \\
...
\includegraphics[width=0.522\textwidth]{figures/tile_scan_stitched_colorgrad_2_crop.png} \\
